...
--  Objetivo:		Se actualizan los datos de la columna "BuyingPortfolio" a "CounterpartPortfolio", 
--					por último se elimina la columna "BuyingPortfolio". 				
--  ====================================================================================================================
DECLARE
...
BEGIN
	...
	AND TABLE_NAME = 'ComEx_CurrencyIntTradeCapture' AND COLUMN_NAME = 'CounterpartPortfolio';
	IF l_rows = 1 THEN
		SELECT COUNT(1) INTO l_rows FROM ALL_TAB_COLUMNS WHERE OWNER = SYS_CONTEXT ('USERENV', 'CURRENT_SCHEMA')
		AND TABLE_NAME = 'ComEx_CurrencyIntTradeCapture' AND COLUMN_NAME = 'BuyingPortfolio';
		IF l_rows = 1 THEN
			...
			EXECUTE IMMEDIATE 'UPDATE "ComEx_CurrencyIntTradeCapture" SET "CounterpartPortfolio" = "BuyingPortfolio"';
			...
			EXECUTE IMMEDIATE 'ALTER TABLE "ComEx_CurrencyIntTradeCapture" DROP COLUMN "BuyingPortfolio"';		
		END IF;
	ELSE
