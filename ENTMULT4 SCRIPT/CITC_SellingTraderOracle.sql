...
--  Objetivo:		Se actualizan los datos de la columna "SellingTrader" a "RecordingTrader", por último se elimina	
--					la columna "SellingTrader". 
--  ====================================================================================================================
DECLARE
...
BEGIN
	...
	AND TABLE_NAME = 'ComEx_CurrencyIntTradeCapture' AND COLUMN_NAME = 'RecordingTrader';
	IF l_rows = 1 THEN
		SELECT COUNT(1) INTO l_rows FROM ALL_TAB_COLUMNS WHERE OWNER = SYS_CONTEXT ('USERENV', 'CURRENT_SCHEMA')
		AND TABLE_NAME = 'ComEx_CurrencyIntTradeCapture' AND COLUMN_NAME = 'SellingTrader';
		IF l_rows = 1 THEN
			...
			EXECUTE IMMEDIATE 'UPDATE "ComEx_CurrencyIntTradeCapture" SET "RecordingTrader" = "SellingTrader"';
			...
			EXECUTE IMMEDIATE 'ALTER TABLE "ComEx_CurrencyIntTradeCapture" DROP COLUMN "SellingTrader"';		
		END IF;
	ELSE
