...
--  Objetivo:		Se actualizan los datos de la columna "BuyingTrader" a "CounterpartTrader", por último se elimina	
--					la columna "BuyingTrader". 
--  ====================================================================================================================
DECLARE
...
BEGIN
	...
	AND TABLE_NAME = 'ComEx_CurrencyIntTradeCapture' AND COLUMN_NAME = 'CounterpartTrader';
	IF l_rows = 1 THEN
		SELECT COUNT(1) INTO l_rows FROM ALL_TAB_COLUMNS WHERE OWNER = SYS_CONTEXT ('USERENV', 'CURRENT_SCHEMA')
		AND TABLE_NAME = 'ComEx_CurrencyIntTradeCapture' AND COLUMN_NAME = 'BuyingTrader';
		IF l_rows = 1 THEN
			...
			EXECUTE IMMEDIATE 'UPDATE "ComEx_CurrencyIntTradeCapture" SET "CounterpartTrader" = "BuyingTrader"';
			...
			EXECUTE IMMEDIATE 'ALTER TABLE "ComEx_CurrencyIntTradeCapture" DROP COLUMN "BuyingTrader"';		
		END IF;
	ELSE
