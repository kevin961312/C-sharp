    ...
    public partial class SaveDropListController : ViewController
    {
        protected override void OnActivated()
        {
            ...
            if (controller != null)
            {
                ...
                if (controller.Active) controller.UpdateNewObjectAction();
            }
        }
        ...
        private void CustomizeList(ICollection<Type> types)
        {
            ...
            foreach (Type item in types) unusableTypes.Add(item);
            foreach (Type item in unusableTypes) types.Remove(item);
        }
        protected override void OnDeactivated()
        {
            NewObjectViewController controller = Frame.GetController<NewObjectViewController>();
            if (controller != null) controller.CollectCreatableItemTypes -= NewObjectViewController_CollectCreatableItemTypes;
            base.OnDeactivated();
        }
    }
}