...
{
    public class CustomTestWinController : ObjectViewController<DetailView, Test_Person>, IModelExtender
    {
        ...
        {
            extenders.Add<IModelViewLayoutElement, IModelLayoutItemTabIndex1>();
        }
    }
    public interface IModelLayoutItemTabIndex1
    {
        [DefaultValue(-1)]
